...
router.get('/due', protect, authorize('nurse', 'admin', 'guest'), getDueMedications);

router.get('/administered/count', protect, authorize('nurse', 'admin', 'guest'), getAdministeredMedicationsCount);

            ...
            <div key={note.id} className="bg-white rounded-lg shadow-lg p-6 border-t-4 border-green-500 hover:shadow-xl transition-shadow duration-300 animate-fade-in-up">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  {note.created_at && (
                    <p className="text-sm text-gray-500">Created: {formatDate(note.created_at)}</p>
                  )}
                  {note.updated_at && note.updated_at !== note.created_at && (
                    <p className="text-sm text-gray-500">Last Updated: {formatDate(note.updated_at)}</p>
                  )}
                  {note.note_type && (
                    <p className="text-md text-gray-600 mt-1"><strong>Note Type:</strong> {note.note_type}</p>
                  )}
                  {note.appointment_id && (
              ...
              <div className="space-y-4 text-gray-700">
                <div className="bg-blue-50 p-4 rounded-md border border-blue-200 shadow-inner">
                  <p className="font-semibold text-blue-800 mb-1">Subjective:</p>
                  <p>
                ...
                {note.vitals && (
                  <div className="bg-green-50 p-4 rounded-md border border-green-200 shadow-inner">
                    <p className="font-semibold text-green-800 mb-1">Objective:</p>
                    <p>
                ...
                {note.diagnosis && (
                  <div className="bg-yellow-50 p-4 rounded-md border border-yellow-200 shadow-inner">
                    <p className="font-semibold text-yellow-800 mb-1">Assessment:</p>
                    <p>
                ...
                <div className="bg-red-50 p-4 rounded-md border border-red-200 shadow-inner">
                  <p className="font-semibold text-red-800 mb-1">Plan:</p>
        ...
        <form onSubmit={handleAddEditSubmit} className="space-y-6">
          ...
          <fieldset className="border border-gray-200 p-4 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              ...
              <div>
                <label htmlFor='note_type' className='block text-gray-700 text-sm font-medium mb-1'>Note Type: <span className="text-red-500">*</span></label>
                <select
                  id='note_type'
                  name='note_type'
              ...
              <div>
                <label htmlFor='appointment_id' className='block text-gray-700 text-sm font-medium mb-1'>Link to Appointment:</label>
                <select
                  id='appointment_id'
                  name='appointment_id'
          ...
          {/* Section: SOAP Notes */}
          <fieldset className="border border-gray-200 p-4 rounded-lg shadow-sm">
            <legend className="text-lg font-semibold text-gray-800 px-2">SOAP Note Details</legend>
            <div className="grid grid-cols-1 gap-6 mt-4">
              <div>
                <label htmlFor='chief_complaint' className='block text-gray-700 text-sm font-medium mb-1'>Subjective: (Chief Complaint & Patient Report) <span className="text-red-500">*</span></label>
                <textarea
                  id='chief_complaint'
              ...
              <div>
                <label htmlFor='vitals' className='block text-gray-700 text-sm font-medium mb-1'>Objective: (Exam Findings & Vitals)</label>
                <textarea
                  id='vitals'
                  name='vitals'
              ...
              <div>
                <label htmlFor='diagnosis' className='block text-gray-700 text-sm font-medium mb-1'>Assessment: (Diagnosis)</label>
                <textarea
                  id='diagnosis'
                  name='diagnosis'
              ...
              <div>
                <label htmlFor='notes' className='block text-gray-700 text-sm font-medium mb-1'>Plan: (Treatment, Meds, Follow-up) <span className="text-red-500">*</span></label>
                <textarea
                  id='notes'
                  name='notes'
              ...
              <div>
                <label htmlFor='medications_prescribed' className='block text-gray-700 text-sm font-medium mb-1'>Medications Prescribed: (Part of Plan)</label>
                <textarea

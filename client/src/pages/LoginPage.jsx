...
function LoginPage() {
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans antialiased"
      initial="initial"
      animate="animate"
      exit="exit"
    ...
    >
      <motion.div
        className="max-w-lg w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl border border-gray-200" // Changed max-w-md to max-w-lg
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <motion.div variants={inputVariants} className="mb-4 relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-md relative block w-full px-3 py-3 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-200 hover:border-blue-500" // Added hover:border-blue-500
            ...
            <motion.div variants={inputVariants} className="relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-md relative block w-full px-3 py-3 pl-10 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-200 hover:border-blue-500" // Added hover:border-blue-500
          ...
          {error && (
            <motion.p
              ...
              className="text-sm text-red-600 bg-red-50 p-3 rounded-md text-center font-medium border border-red-200"
            >
              {error}
            </motion.p>
          )}
